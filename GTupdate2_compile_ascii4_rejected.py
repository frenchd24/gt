...
#         outFilename = '/usr/data/moosejaw/frenchd/GT_update2/FinalGalaxyTable3.csv'
        ...
        outFilename = '/usr/data/moosejaw/frenchd/GT_update2/rejected_final_combined_group_ascii3.dat'
        outFilename2 = '/usr/data/moosejaw/frenchd/GT_update2/rejected_final_combined_group_ascii3_altnames.dat'
        outFilename3 = '/usr/data/moosejaw/frenchd/GT_update2/rejected_final_combined_group_ascii3_altnamesLEFT.dat'
...
#     fullTable2 = numpy.array(fullTable)
#     fullTable3 = numpy.transpose(fullTable2)
    
#     fullTable3 = map(list, zip(*fullTable))
#     fullTable4 = table.Table(fullTable3, names=fieldnames)
