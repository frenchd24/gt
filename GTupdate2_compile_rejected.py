...
$Id: GTupdate2_compile_rejected.py, v 1 09/11/2017

Combine the following files:
rejected_results_redo_extinc_rc3.csv
rejected_processedPhot_extinc.csv
rejected_processedDiams.csv

into one table called: rejected_final_combined.csv (09/11/17)

DID NOT USE FOR THE NEXT VERSION, 'rejected_final_combined2.csv' I USED THE REGULAR CODE,
GTupdate2_compile.py FOR THAT ONE.

Based on:
Id: GTupdate2_compile.py, v 1 05/18/2017
...
#         outFilename = '/usr/data/moosejaw/frenchd/GT_update2/FinalGalaxyTable.csv'
        ...
        paFilename = '/usr/data/moosejaw/frenchd/GT_update2/rejected_processedDiams.csv'
        photFilename = '/usr/data/moosejaw/frenchd/GT_update2/rejected_processedPhot_extinc.csv'
        outFilename = '/usr/data/moosejaw/frenchd/GT_update2/rejected_final_combined.csv'
    ...
    'vcorr (km/s)',\
    'distvcorr (Mpc)',\
    'zIndependentDist_mean_std_min_max (Mpc)',\
    'bestDistance (Mpc)',\
    'distErr (Mpc)',\
    'angDiameters (arcsec)',\
