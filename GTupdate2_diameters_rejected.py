...
$Id: GTupdate2_diameters_rejected.py, v 1.1 09/08/2017

Do the below on the file rejected_results_redo_extinc.csv and
rejected_results_redo_pa2.csv, resulting in : rejected_processedDiams.csv (09/11/17)


Based on:
Id: GTupdate2_diameters.py, v 1 04/14/2017
...
import math
from choose_diameter_measurement import choose_diameter_measurement
...
#         outFilename = '/usr/data/moosejaw/frenchd/GT_update2/processedDiams2.csv'
        ...
        outFilename = '/usr/data/moosejaw/frenchd/GT_update2/rejected_processedDiams.csv'
