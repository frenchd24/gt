...
$Id: GTupdate2_add_virial.py, v1 09/08/17

Add virial radius column to the table
...
def main():
    ...
    if user == 'frenchd':
        inFilename = '/usr/data/moosejaw/frenchd/GT_update2/FinalGalaxyTable4_1.csv'
        outFilename = '/usr/data/moosejaw/frenchd/GT_update2/FinalGalaxyTable4_2.csv'
        
    elif user == 'David':
        inFilename = '/Users/David/Research_Documents/GT_update2/FinalGalaxyTable4_1.csv'
        outFilename = '/Users/David/Research_Documents/GT_update2/FinalGalaxyTable4_2.csv'
...
#         B_min_key
      ...
      # Lstar_sdss_err
        ...
        # altNames - no idea what to do with this one.
#         altNames
...
##########################################################################################
        ...
        row = dict((f,o) for f,o in zip(fieldnames,dat))
        writer.writerow(row)
...
#         if count % 50:
#             # write it to file
#             ascii.write(t, outFilename,format='csv',\
