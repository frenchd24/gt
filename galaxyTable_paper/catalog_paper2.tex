...
%        \centering
%        \vspace{0pt}
%        \includegraphics[width=0.999\columnwidth, angle=90]{Chap2/figures/all_sky.pdf} \label{a}
%        \includegraphics[width=0.99\columnwidth, angle=90]{Chap2/figures/all_sky_6h.pdf} \label{b}
%        \includegraphics[width=0.99\columnwidth, angle=90]{Chap2/figures/all_sky_12h.pdf} \label{c}
...
\begin{figure*}[p]
        \centering
        \vspace{0pt}
        \includegraphics[width=0.572\textwidth, angle=0]{all_sky.pdf} \label{a}
...
\begin{figure*}[p]
        \centering
        \vspace{0pt}      
        \includegraphics[width=0.565\textwidth, angle=0]{all_sky_6h.pdf} \label{b}
...
\begin{figure*}[p]
        \centering
        \vspace{0pt}
        \includegraphics[width=0.57\textwidth, angle=0]{all_sky_12h.pdf} \label{c}
